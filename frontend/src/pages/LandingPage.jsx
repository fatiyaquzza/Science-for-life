          ...
          <div className="grid items-center grid-cols-1 gap-16 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mb-6 text-lg leading-relaxed text-gray-600">
                ILMANA (Ilmu Manusia dan Alam) hadir sebagai jembatan inovatif
                bagi siswa yang ingin memperdalam sains kehidupan,
                kontekstual, berbasis penelitian, dan meningkatkan literasi
                sains yang sebenarnya membuka makna menjaga kehidupan,
